...
- `spec-livememory` duplicate sentence still says warn-then-allow. **Refresh SPEC (and PRD if needed) to AD-10 before epic/story breakdown** so stories do not implement the old rule.
